...
import { 
  ...
  Loader2, Shield, KeyRound, Sparkles,
  CheckCircle, AlertCircle, ShieldCheck,
  LogIn, Users, Zap, Star, 
  Building, Target, Layers, ArrowLeft,
  User, Crown, Key, Rocket, Globe,
  Fingerprint, SparklesIcon, PartyPopper,
...
export default function LoginPage() {
  ...
  const handleDemoLogin = (role: 'user' | 'admin' | 'superadmin') => {
      ...
      {showSuccess && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white rounded-3xl p-12 max-w-md text-center animate-scaleIn">
            ...
            <h3 className="text-3xl font-bold text-gray-900 mb-4">Login Successful!</h3>
              ...
              <div className="space-y-12">
                <div>
                  ...
                  <p className="text-xl text-gray-600 mb-12 max-w-lg">
                    Access your personalized dashboard with advanced security features 
                    and role-based control systems.
                  </p>
                </div>
                ...
                <div className="pt-8">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    >
                      ...
                      <span className="text-sm font-semibold text-gray-900">User Demo</span>
                ...
                <div className="relative bg-white rounded-3xl shadow-2xl p-10 border border-white/20 backdrop-blur-sm">
                  ...
                  {loginMutation.isError && (
                    <div className="mb-6 p-5 rounded-xl bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 shadow-sm animate-shake">
                      <div className="flex items-center">
                        ...
                        <div>
                          <p className="text-red-700 font-bold">Authentication Failed</p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-7">
                    ...
                    <div className="space-y-3">
                      ...
                      />
                      {errors.email && (
                        <p className="text-red-500 text-sm font-medium animate-fadeIn">{errors.email}</p>
                      )}
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      {errors.password && (
                        <p className="text-red-500 text-sm font-medium animate-fadeIn">{errors.password}</p>
                      )}
                    ...
                    <div className="relative py-4">
                      ...
                      <div className="relative flex justify-center">
                        <span className="px-4 bg-white text-sm font-medium text-gray-500">Or continue with</span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      >
                        <svg className="w-5 h-5 mr-3 text-gray-600 group-hover:text-blue-600" viewBox="0 0 24 24">
                      ...
                      >
                        <svg className="w-5 h-5 mr-3 text-gray-600 group-hover:text-blue-600" fill="currentColor" viewBox="0 0 24 24">
